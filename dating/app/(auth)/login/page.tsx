      ...
      <div className="w-full max-w-md">
        ...
        <div className="card p-8">
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              <div className="flex justify-between mb-1.5">
                ...
                <Link href="/forgot-password" className="text-sm text-brand-500 hover:text-brand-600">Forgot?</Link>
              </div>
          ...
          <button onClick={() => signIn('google', { callbackUrl: '/home' })}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-gray-200 rounded-xl hover:bg-gray-50 transition-all font-medium">
        ...
        <p className="text-center text-gray-500 mt-6">
          ...
          <Link href="/register" className="text-brand-500 font-semibold hover:text-brand-600">Sign up free</Link>
        </p>
      </div>
    </div>
  )
