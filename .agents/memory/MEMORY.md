...
- [Premium entitlement recovery](premium-entitlements.md) — resolve active paid tier access from completed order history when the user row lacks a reliable priority
