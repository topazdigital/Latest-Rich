      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-gray-900 border-r border-gray-800 transform transition-transform duration-200 ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} md:relative md:translate-x-0`}>
        <div className="p-4 border-b border-gray-800">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl gradient-brand flex items-center justify-center text-white font-bold text-lg">R</div>
            <div>
        ...
        <div className="p-4">
          <div className="flex items-center gap-3 mb-6 p-3 bg-gray-800 rounded-xl">
            ...
            <div>
              ...
              <div className="text-brand-400 text-xs">ADMINISTRATOR</div>
            </div>
          </div>
          ...
          <div className="mt-6 pt-6 border-t border-gray-800">
            <button onClick={() => setLocation("/home")} className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-gray-400 hover:bg-gray-800 hover:text-white transition-colors">
