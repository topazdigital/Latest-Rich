...
const DEFAULT_PACKAGES = [
  { id: 1, name: '1 Month', days: 30, price: 9.99, popular: 0, description: 'Flexible monthly plan', priority: 1 },
  { id: 2, name: '3 Months', days: 90, price: 24.99, popular: 1, description: 'Save 17%', priority: 2 },
  { id: 3, name: '6 Months', days: 180, price: 39.99, popular: 0, description: 'Save 33%', priority: 3 },
  { id: 4, name: '1 Year', days: 365, price: 59.99, popular: 0, description: 'Best value — Save 50%', priority: 4 },
]
